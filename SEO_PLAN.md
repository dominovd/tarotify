# TarotAxis SEO Plan — May 2026

## Ситуация

**TarotAxis.app** — современный чистый инструмент, но контент тонкий. Главный конкурент **free-tarot-reading.net** (Lotus Tarot, 200M+ ридингов с 2002) держит позиции 20–50 по сотням карточных ключей с объёмом 1,000–22,200, что означает — они уязвимы для обгона качественным контентом.

---

## Разрыв: что есть у конкурента, чего нет у нас

| Фича | Lotus Tarot | TarotAxis |
|------|------------|---------|
