...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://tarotaxis.com/spreads/by-card-count' },
  openGraph: {
        ...
        <section key={group.count} style={{ marginBottom: '3rem' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '.75rem' }}>
            {group.items.map(item => (
              <Link key={item.href} href={item.href} style={{ display: 'block', background: 'rgba(255,255,255,.03)', border: '1px solid var(--border)', borderRadius: 12, padding: '1.1rem 1.25rem', transition: 'border-color .2s' }}>
