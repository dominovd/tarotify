...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://tarotaxis.com/tarot-suits' },
  openGraph: {
            ...
            return (
              <Link key={s.slug} href={s.href} style={{ display: 'block', background: 'rgba(255,255,255,.03)', border: '1px solid var(--border)', borderRadius: 14, padding: '1.25rem 1.25rem 1.4rem', textDecoration: 'none' }}>
                ...
                <div style={{ display: 'flex', gap: '.4rem', flexWrap: 'wrap', marginBottom: '.7rem' }}>
                  ...
                  <span style={{ padding: '.15rem .55rem', borderRadius: 20, fontSize: '.62rem', background: 'rgba(255,255,255,.04)', color: 'var(--muted)', fontFamily: "'Cinzel',serif", letterSpacing: '.06em' }}>{suitCards.length} cards</span>
                </div>
