...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `https://tarotaxis.com/cards/${card.slug}`,
      languages: {
        'en': `https://tarotaxis.com/cards/${card.slug}`,
        'es': `https://tarotaxis.com/es/cartas/${esSlug}`,
        'x-default': `https://tarotaxis.com/cards/${card.slug}`,
      },
    },
    openGraph: {
